<%@ Page Title="ניהול זמנים" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewZman.aspx.cs" Inherits="synaManage.NewZman" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group" >
     ...
     <div class="form-group" >
          ...
          <asp:TextBox ID="numericMinutes"  runat="server" TextMode="Number" width="60" Text="30"></asp:TextBox>
